...
- Evidence: `scripts/f0/` and the CI schema-proof job; current [Supabase connection modes](https://supabase.com/docs/guides/database/connecting-to-postgres) and [Vault guidance](https://supabase.com/docs/guides/database/vault).
