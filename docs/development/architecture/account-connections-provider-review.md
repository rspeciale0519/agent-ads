...
- Dubsado, WordPress, VideoAsk, organic, and asset routes use the manual lifecycle service. Dubsado records only an approved export or client-owned integration source and date; no Zapier-only key is accepted.
