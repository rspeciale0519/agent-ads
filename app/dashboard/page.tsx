...
export default async function DashboardPage() {
  ...
  return <main className="workspace-shell">
    <header className="workspace-header">
      ...
      <div className="workspace-header-actions"><span className="workspace-role">{dashboard.organization.role}</span><Link className="secondary-button" href="/ai-reach">AI Reach</Link><Link className="secondary-button" href="/onboarding">Onboarding</Link><Link className="secondary-button" href="/connections">Account Connections</Link>{["owner", "administrator"].includes(context.role) && <Link className="secondary-button" href="/settings/data">Data controls</Link>}</div>
    </header>
